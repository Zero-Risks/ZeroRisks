    ...
    <body class="bg-light">
        ...
        <header class="bg-white shadow-sm mb-4">
            <div class="container d-flex justify-content-between align-items-center py-2">
                <div>
                    <a href="/controllers/cerrar_sesion.php" class="btn btn-outline-primary">Cerrar sesión</a>
                </div>
        ...
        <main>
            ...
            <div class="cuadros-container">
                ...
                <div class="cuadro cuadro-2">
                    <div class="cuadro-1-1">
                        <a href="permisos/permisos.php" class="titulo">Permisos</a>
                        <p>Version beta v2</p>
                    </div>
                </div>
                ...
                <?php if ($tiene_permiso_apagar_sistema) : ?>
                    <div class="cuadro cuadro-2">
                        <div class="cuadro-1-1">
                            <a href="apagarSis/apagarSist.php" class="titulo">Apagar Sistema</a>
                            <p>Version beta v2</p>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="cuadro cuadro-2">
                    <div class="cuadro-1-1">
                        <a href="../historial/historial.php" class="titulo">Historial ingresos</a>
                        <p>Version beta v2</p>
                    </div>
                </div>
                ...
                // Asegúrate de que el ID de usuario está establecido en la sesión
                if (isset($_SESSION["usuario_id"])) {
                    $usuario_id = $_SESSION["usuario_id"];

                    // Consulta para verificar si el usuario actual tiene registros en la tabla saldo_admin
                    $sql = "SELECT COUNT(*) FROM saldo_admin WHERE IDUsuario = ?";
                    $stmt = $conexion->prepare($sql);

                    if ($stmt) {
                        // Enlaza el ID de usuario a la consulta
                        $stmt->bind_param("i", $usuario_id);
                        $stmt->execute();

                        // Obtiene el resultado y cuenta el número de filas
                        $result = $stmt->get_result();
                        $row = $result->fetch_row();
                        $count = $row[0];

                        // Verifica si la tabla está vacía para ese usuario
                        if ($count == 0) {
                            // Mostrar el cuadro
                ?>
                            <div class="cuadro cuadro-2">
                ...
                <div class="cuadro cuadro-3">
                    <div class="cuadro-1-1">
                        <a href="/resources/views/admin/cobros/cobros.php" class="titulo">Zonas de cobro</a><br>
                        <p>Version beta v2</p>
                    </div>
                </div>
