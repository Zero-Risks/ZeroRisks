...
if (isset($_POST['usuario_id'])) {
    ...
    if ($_SESSION["rol"] == 1) { // Administrador
        $_SESSION["ruta_retorno"] = "../inicio/inicio.php";
    } else { // Supervisor
...
function determinarRutaRetornoSupervisor($zonaSupervisor)
{
    switch ($zonaSupervisor) {
        case '06':
            return "../../zonas/Chihuahua/supervisor/inicio.php";
        case '20':
            return "../../zonas/Puebla/supervisor/inicio.php";
...
function determinarRutaDashboard($zona, $rol)
{
    switch ($zona) {
        case '06':
            return $rol == 2 ? "../../zonas/6-Chihuahua/supervisor/inicio/inicio.php" : "../../zonas/6-Chihuahua/cobrador/inicio/inicio.php";
        case '20':
