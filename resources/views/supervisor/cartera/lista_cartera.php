...
// Obteniendo el ID del usuario de la sesión
$usuarioId = $_SESSION['usuario_id'];

// Consulta SQL para obtener las carteras asociadas al ID del usuario en sesión
$sql = "SELECT carteras.id, carteras.nombre, carteras.zona, ciudades.nombre AS nombre_ciudad, carteras.asentamiento 
        ...
        WHERE carteras.id_usuario = ?"; // Filtrar por el ID del usuario en sesión

$stmt = $conexion->prepare($sql);
$stmt->bind_param("i", $usuarioId); // Vinculando el ID del usuario
$stmt->execute();
