...
if (!is_numeric($tasa_interes)) {
    header('Location: /resources/views/supervisor/desatrasar/hacerPrestamo.php?mensaje=La tasa de interés no es válida.');
...
if ($conexion->query($sql) === TRUE) {
    ...
    header("Location: /resources/views/supervisor/desatrasar/index.php?idPrestamo=" . $id_prestamo);
    exit;
} else {
    // Redirigir al usuario a crudprestamo.php con un mensaje de error
    header('Location: /resources/views/supervisor/desatrasar/hacerPrestamo.php?mensaje=Error al solicitar el préstamo: ' . $conexion->error);
    exit;
}
