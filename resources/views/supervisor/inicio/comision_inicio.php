...
// Consulta SQL para obtener solo los prestamos donde el CobradorAsigando sea igual al id del usuario en sesión
$sql = "SELECT prestamos.ID, clientes.Nombre AS NombreCliente, clientes.Apellido, prestamos.MontoAPagar, prestamos.Comision
        FROM prestamos
        INNER JOIN clientes ON prestamos.IDCliente = clientes.ID
        WHERE prestamos.CobradorAsignado = ?
                ...
                <?php if ($result->num_rows > 0) : ?>
                    <?php while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td><?php echo $row['NombreCliente'] . " " . $row['Apellido']; ?></td> 
