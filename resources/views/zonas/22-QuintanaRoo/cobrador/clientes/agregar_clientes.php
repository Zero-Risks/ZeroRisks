...
<body id="body">
    ...
    <main class="form-container">
        ...
        <form action="/controllers/cob/validar_clientes/validar_clientes20.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select id="ciudad" name="ciudad">
                        ...
                        $consultaRoles = "SELECT ID, Nombre FROM ciudades WHERE IDZona = 20";
