...
$sql = "SELECT c.ID, c.Nombre, c.Apellido, p.ID AS IDPrestamo
        ...
        AND c.ZonaAsignada = 'Quintana Roo'";
...
<body>
    ...
    <header>
    <a href="/resources/views/zonas/22-QuintanaRoo/cobrador/inicio/cartulina/perfil_abonos.php?id=<?= $primer_id ?>" class="back-link1">Volver</a>

        <!-- <a href="/resources/views/zonas/22-QuintanaRoo/cobrador/inicio/cartulina/orden_abonos.php" class="back-link1">Pendintes hoy</a> -->
