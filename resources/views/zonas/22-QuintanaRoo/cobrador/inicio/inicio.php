    ...
    <main>
        ...
        <div class="cuadros-container">
            ...
            <?php if ($tiene_permiso_lista_clavos) : ?>
                <div class="cuadro cuadro-2">
                    <div class="cuadro-1-1">
                        <a href="/resources/views/zonas/22-QuintanaRoo/cobrador/inicio/Clavos/ListaClavos.php" class="titulo">Clavos </a>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ($tiene_permiso_prest_cancelados) : ?>
                <div class="cuadro cuadro-2">
                    <div class="cuadro-1-1">
                        <a href="/resources/views/zonas/22-QuintanaRoo/cobrador/inicio/Pcancelados/pcancelados.php" class="titulo">Prest Cancelados </a>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ($tiene_permiso_comision) : ?>
                <div class="cuadro cuadro-2">
                    <div class="cuadro-1-1">
                        <a href="/resources/views/zonas/22-QuintanaRoo/cobrador/inicio/comision_inicio.php" class="titulo">Comision</a>
                        <p>Version beta</p>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ($tiene_permiso_gastos) : ?>
                <div class="cuadro cuadro-3">
                    <div class="cuadro-1-1">
                        <a href="/resources/views/zonas/22-QuintanaRoo/cobrador/gastos/lista/lista_gastos.php" class="titulo">Gastos</a><br>
