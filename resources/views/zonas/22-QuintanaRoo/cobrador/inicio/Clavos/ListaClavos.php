...
$zonaSeleccionada = 'Quintana Roo'; // Cambiar la zona a Quintana Roo
$todosLosClavos = [];
...
<body>
    <div class="container mt-4">
        <h1 class="mb-4">Lista de Clavos de Quintana Roo</h1>

        <!-- Filtro de Zona (puede eliminar esta sección ya que siempre mostrará información de Quintana Roo) -->
