...
<body>
    <header>
        <a href="../inicio/inicio.php" class="botonn">
    ...
    <div class="container mt-5">
        ...
        if ($id_cliente_url) {
            ...
            if ($cliente && isset($prestamo)) {
                // Mostrar detalles solo para el préstamo específico
                $fechaInicio = strtotime($prestamo['FechaInicio']);
                $fechaActual = strtotime(date("Y-m-d"));
                $plazoPrestamo = $prestamo['Plazo'];
                ...
                echo '<a href="editar_prestamo.php?prestamo_id=' . $prestamo['ID'] . '" class="btn btn-editar-prestamo">Editar Préstamo</a>';
                echo '</div>';

                echo '<form action="procesar_pagos.php" method="post" class="card card-body" data-monto-a-pagar="' . $prestamo['MontoAPagar'] . '">';

                echo '<input type="hidden" name="prestamo_id" value="' . $prestamo['ID'] . '">';
                ...
                echo '<input type="text" id="prestamo_detalle" class="form-control" value="Préstamo: ' . number_format($prestamo['MontoAPagar'], 0, ',', '') . ' - Fecha: ' . date("d/m/Y", $fechaInicio) . '" readonly>';
                echo '</div>';
                ...
                echo '<input type="hidden" id="monto_cuota_oculto" value="' . $prestamo['MontoCuota'] . '">';
                echo '</div>';
                ...
                // Mostrar un mensaje de error si no se encontró el préstamo
                echo '<div class="alert alert-danger" role="alert">No se encontró el préstamo con el ID proporcionado.</div>';
            }
        }
        ?>
    </div>
