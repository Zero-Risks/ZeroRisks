...
// Consulta para obtener la lista de usuarios creados por el usuario autenticado
$usuariosSQL = $conexion->prepare("SELECT * FROM usuarios WHERE estado = 'activo' AND Zona = 22 AND SupervisorID = ?");
$usuariosSQL->bind_param("i", $usuario_id);
$usuariosSQL->execute();
$resultado = $usuariosSQL->get_result();
