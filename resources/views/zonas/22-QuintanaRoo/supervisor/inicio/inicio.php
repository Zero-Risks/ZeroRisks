...
$sql_total_prestamos = "SELECT COUNT(*) AS total FROM prestamos WHERE Zona = 'Quintana Roo'";
$resultado = $conexion->query($sql_total_prestamos);
$fila = $resultado->fetch_assoc();
$total_prestamos = $fila['total'];

//OBTENER EL TOTAL CLIENTES 
$sql_total_clientes = "SELECT COUNT(*) AS total FROM clientes  WHERE ZonaAsignada = 'Quintana Roo'";
