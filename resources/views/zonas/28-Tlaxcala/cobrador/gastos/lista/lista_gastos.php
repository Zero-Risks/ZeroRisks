...
if (!$tiene_permiso_gastos) {
    ...
    if (!$fila) {
        ...
        header("Location: /resource/views/zonas/28-tlaxcala/cobrador/inicio/inicio.php");
        exit();
    }
...
<body>
    <main>
        <div class="toolbar">
            ...
            <a href="/resources/views/zonas/28-Tlaxcala/cobrador/inicio/inicio.php" class="add-button">Volver</a>

            <a href="/resources/views/zonas/28-Tlaxcala/cobrador/gastos/agregar/agregar_gastos.php" class="add-button">+ Añadir
                gasto</a>
            ...
            <table class="gastos-table">
                ...
                if ($resultado->num_rows > 0) {
                    while ($fila = $resultado->fetch_assoc()) {
                        echo '<tr>';
                        echo '<td>' . $fila['ID'] . '</td>';
                        echo '<td><a href="/resources/views/zonas/28-Tlaxcala/cobrador/gastos/editar/editar_gasto.php?id=' . $fila['ID'] . '">' . $fila['Nombre'] . '</a></td>';
