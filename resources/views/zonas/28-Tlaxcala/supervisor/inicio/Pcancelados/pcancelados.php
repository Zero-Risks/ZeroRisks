...
$sql = "SELECT p.*, CONCAT(c.Nombre, ' ', c.Apellido) AS NombreCompleto, c.IdentificacionCURP, MAX(f.fecha) AS ultima_fecha_pago, u.Nombre AS NombreCreador, u.Apellido AS ApellidoCreador
        ...
        WHERE p.Estado = 'pagado' AND p.Zona = 'Tlaxcala'"; // Agregar la condición de ubicación
        ...
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <select id="usuario_creador" name="usuario_creador" class="form-control">
                    ...
                    // Consulta SQL para obtener la lista de usuarios de Tlaxcala
                    $sqlUsuarios = "SELECT ID, CONCAT(Nombre, ' ', Apellido) AS NombreCompleto FROM usuarios WHERE Zona = 28";
