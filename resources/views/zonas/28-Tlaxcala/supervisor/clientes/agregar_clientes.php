...
if (!$tiene_permiso_listar_clientes) {
    ...
    if (!$fila) {
        ...
        header("Location: /resource/views/zonas/20-Tlaxcala/supervisor/inicio/inicio.php");
        exit();
    }
...
<body id="body">
    ...
    <main class="form-container">
        ...
        <form action="/controllers/super/validar_clientes/validar_clientes28.php" method="POST" enctype="multipart/form-data">
