...
<body id="body" class="bg-light">
    ...
    <main class="container">
        ...
        <div class="search-container my-3">
            <input type="text" id="search-input" class="form-control" placeholder="Buscar..." autocomplete="off"  oninput="this.value = this.value.toUpperCase()">
        </div>
                ...
                <?php if ($resultado->num_rows > 0) : ?>
                    <?php while ($fila = $resultado->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td><?php echo $fila["MontoAPagar"]; ?></td>
