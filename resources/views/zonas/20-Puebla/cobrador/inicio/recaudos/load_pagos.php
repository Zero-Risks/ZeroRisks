...
$sqlBase = "SELECT hp.*, CONCAT(c.Nombre, ' ', c.Apellido) AS NombreCompletoCliente, 
                   c.IdentificacionCURP AS CURPCliente, u.Nombre AS NombreUsuario
            FROM historial_pagos hp
            LEFT JOIN clientes c ON hp.IDCliente = c.ID
            LEFT JOIN usuarios u ON hp.IDUsuario = u.ID
            WHERE hp.IDUsuario = $usuario_id";
