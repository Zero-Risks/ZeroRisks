...
//PERMISOS A VER FILTROS
if (!$tiene_permiso_ver_filtros) {
...
<body>
    ...
    <header>
        <a href="../inicio.php" class="botonn">
    ...
    <main>
        ...
        <form action="prestamos_del_dia.php" method="get">
            ...
            <div class="header-actions">
                ...
                <a href="/resources/views/zonas/20-Puebla/supervisor/clientes/agregar_clientes.php" class="btn btn-success" style="margin-left: 10px;">Registrar Cliente</a>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($cuotasHoy as $cuota) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="../../cartulinaV2/abonos.php?id=<?php echo $cuota['IDCliente']; ?>" class="btn btn-info">Perfil </a>
