...
if (!$tiene_permiso_desatrasar) {
    ...
    if (!$fila) {
        ...
        header("Location: /resource/views/zonas/6-chihuahua/cobrador/inicio/inicio.php");
        exit();
    }
...
<body style="background-color: #a8dbd6;">
    ...
    <main>
        ...
        <form action="/controllers/validar_cliente_ChihuahuaCob.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-container">
                ...
                <select id="ciudad" name="ciudad" required>
                    ...
                    include("../../../../../../controllers/conexion.php");
                    // Consulta SQL para obtener las zonas
                    $consultaZonas = "SELECT * FROM ciudades WHERE iDZona = 06";
                    $resultZonas = mysqli_query($conexion, $consultaZonas);
                    // Genera las opciones del menú desplegable para Zona
                    while ($row = mysqli_fetch_assoc($resultZonas)) {
                        echo '<option value="' . $row['ID'] . '">' . $row['Nombre'] . '</option>';
