...
$sql_total_prestamos = "SELECT COUNT(*) AS total FROM prestamos WHERE Zona = 'Puebla'";
$resultado = $conexion->query($sql_total_prestamos);
$fila = $resultado->fetch_assoc();
$total_prestamos = $fila['total'];

//OBTENER EL TOTAL CLIENTES 
$sql_total_clientes = "SELECT COUNT(*) AS total FROM clientes  WHERE ZonaAsignada = 'Puebla'";
    ...
    <body class="bg-light">
        ...
        <header class="bg-white shadow-sm mb-4">
            <div class="container d-flex justify-content-between align-items-center py-2">
                <?php if (!isset($_SESSION["sesion_temporal"]) || $_SESSION["sesion_temporal"] === false) : ?>
                    <div>
                        <a href="/controllers/cerrar_sesion.php" class="btn btn-outline-primary">Cerrar sesión</a>
                    </div>
                <?php endif; ?>

                <?php if (isset($_SESSION["sesion_temporal"]) && $_SESSION["sesion_temporal"] === true) : ?>
                    <div>
                        <a href="../../../../admin/panel/volver_a_admin.php" class="btn btn-warning">
                            Volver a <?php echo $_SESSION["original_rol_nombre"]; ?>
                        </a>
                    </div>
                <?php endif; ?>
                <div class="card">
