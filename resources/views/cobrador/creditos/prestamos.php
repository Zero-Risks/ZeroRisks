                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="monto" id="monto" class="form-control" required oninput="calcularMontoPagar()" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label for="tasa_interes">Tasa de Interés (%):</label>
                                <input type="text" name="TasaInteres" id="TasaInteres" class="form-control" required oninput="calcularMontoPagar()" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label for="frecuencia_pago">Frecuencia de Pago:</label>
                                <select name="frecuencia_pago" id="frecuencia_pago" class="form-control" required onchange="calcularMontoPagar()" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="plazo" id="plazo" class="form-control" required oninput="calcularMontoPagar()" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group" id="comision_container" style="display: none;">
                                ...
                                <input type="text" name="valor_comision" id="valor_comision" class="form-control" autocomplete="off">
                            </div>
