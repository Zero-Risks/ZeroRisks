...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/desatrasar.css">
    ...
    <body>
        <header class="bg-white shadow-sm mb-4">
            <div class="container d-flex justify-content-between align-items-center py-2">
                <div>
                    <a class="navbar-brand" href="/resources/views/admin/inicio/inicio.php">
        ...
        <div class="container mt-5">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">Monto a Pagar del Préstamo: <?php echo round($prestamo['MontoAPagar']); ?></p>
                    <a href="../desatrasar/editar_prestamo.php?prestamo_id=<?php echo $prestamo['ID']; ?>" class="btn btn-primary">Editar Préstamo</a>
                </div>
            </div>
...
$conexion->close();
    ...
    function generarCuotasDiarias($fechaInicio, $montoCuota, $numCuotasEspecificadas, $fechaHoy)
    {
        ...
        while ($numCuotasEspecificadas === null || $numCuotasGeneradas < $numCuotasEspecificadas) {
            ...
            // Redondea el monto de la cuota
            $montoRedondeado = round($montoCuota);

            $cuotas[] = [
                'fecha' => $fechaActual->format('Y-m-d'),
                'monto' => $montoRedondeado
            ];
            $montoTotal += $montoRedondeado; // Suma al monto total redondeado
            $fechaActual->modify('+1 day');
            $numCuotasGeneradas++;
        }

        // Redondea el monto total
        $montoTotalRedondeado = round($montoTotal);

        return ['cuotas' => $cuotas, 'montoTotal' => $montoTotalRedondeado]; // Devuelve las cuotas y el monto total redondeado
    }
    ?>